...
class NadamOptimizer(AdamOptimizer):
  ...
  #=============================================================
  def __init__(self, learning_rate=0.002, beta1=.9, beta2=.9, eps=1e-16, chi=0., clip=0., noise=None, use_locking=False, name='Nadam'):
    """"""
    
    super(NadamOptimizer, self).__init__(lr=learning_rate, mu=beta1, ups=beta2, eps=eps,
