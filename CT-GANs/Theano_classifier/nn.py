...
#z_hat = nn.DenoiseLayer(u_net=u, z_net=z_c)
...
class DenoiseLayer(MergeLayer):
    ...
    def __init__(self, u_net, z_net,
        ...
        self.a1 = self.add_param(0., (10,10))
        self.a2 = self.add_param(1., (10,10))
        self.a3 = self.add_param(0., (10,10))
        self.a4 = self.add_param(0., (10,10))

        self.c1 = self.add_param(0., (10,10))
        self.c2 = self.add_param(1., (10,10))
        self.c3 = self.add_param(0., (10,10))

        self.c4 = self.add_param(0., (10,10))

        self.b1 = self.add_param(0., (10,10),
                                  regularizable=False)
...
class DenoiseLayer3(MergeLayer):
    """
        Special purpose layer used to construct the ladder network
        See the ladder_network example.
    """
    def __init__(self, u_net, z_net,
        ...
        super(DenoiseLayer3, self).__init__([u_net, z_net], **kwargs)
